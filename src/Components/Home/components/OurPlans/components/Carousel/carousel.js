...
export function panningNext() {
  ...
  slides[4].classList.add('to-left')
  gsap.from('.to-left', {duration: 1, transform: 'translatex(10.5rem)'})
  
  slides[5].dataset.type = 'active';
  slides[5].classList.add('from-after');
  gsap.from('.from-after', {duration: 1, transform: 'translatex(7rem)', scale: '0.8'})
  
  slides[6].dataset.type = 'after';
  slides[6].classList.add('fade-in');
