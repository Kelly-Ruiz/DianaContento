...
function ChallengesIcon({ color, className }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.44 56.49">
      <defs>
